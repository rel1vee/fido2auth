 ...
 *
 * Represents a single WebAuthn credential registered by a customer.
 * Maps to the `fido2_credentials` database table. Each credential stores
 * the public key, sign counter, attestation metadata, and device info
 * needed for authentication verification.
 *
 * @author  Muh. Zaki Erbai Syas
 * @license AFL-3.0
 * @package PrestaShop\Module\Fido2Auth\Entity
 */
