 ...
 *
 * Business logic layer for managing WebAuthn credentials.
 * Handles registration, deletion, usage tracking, and ownership verification.
 * Acts as an intermediary between controllers and the CredentialRepository.
 *
...
class CredentialManager
{
    ...
    {
        // Note: The webauthn-lib already validates sign count during assertion verification.
        // Platform authenticators (Windows Hello, Touch ID) may always return 0.
        // We just update the stored value and timestamp here.
