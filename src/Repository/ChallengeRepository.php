 ...
 *
 * Data access layer for the `fido2_challenges` database table.
 * Handles creating, validating, and cleaning up single-use cryptographic
 * challenges used during WebAuthn registration and authentication flows.
 *
 * @author  Muh. Zaki Erbai Syas
 * @license AFL-3.0
 * @package PrestaShop\Module\Fido2Auth\Repository
 */
